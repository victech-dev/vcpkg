...
function(vcpkg_find_acquire_program VAR)
  ...
  elseif(VAR MATCHES "BAZEL3_2_0")
    set(PROGNAME bazel)
    set(BAZEL_VERSION 3.2.0)
    set(SUBDIR ${BAZEL_VERSION})
    set(PATHS ${DOWNLOADS}/tools/bazel/${SUBDIR})
    set(_vfa_RENAME "bazel")
    if (VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
      set(_vfa_SUPPORTED ON)
      set(URL "https://github.com/victech-dev/vcpkg/raw/victech/victech/tools/bazel-3.2.0-aarch64")
      set(ARCHIVE "bazel-3.2.0-aarch64")
      set(NOEXTRACT ON)
      set(HASH 42cce80baeeca72907219df7e554bd42c747e71e1c100c7795a8104904a04035a3828fba4760ff7e34033394c7dca9ab34138d4ff806350a08549e2d45ba22b6)
    elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
      ...
      set(NOEXTRACT ON)
      set(HASH cfcac042dfd41032c2c6eb68c7261951d36f01f2fec6c46e8e80a6cd86df23614011aae1508a84d6cafcef1a1b9eb35eaba07bfb5ba20f25f7da9dd7e1c9b630)
    else()
      ...
      set(HASH 70c198d88a1172345fdfbe099828a10ff9e6a81d6694a452ea17c2f7c5e88b41e5becaac1ecfa908d6bd44a3886dee488fc04072c0f902cecd50b4139032fdf1)
    endif()
