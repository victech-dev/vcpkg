...
if(CMAKE_HOST_WIN32)
	...
	set_target_properties(tensorflow_cc::tensorflow_cc
		PROPERTIES 
		IMPORTED_IMPLIB_RELEASE ${CMAKE_CURRENT_LIST_DIR}/../../lib/liblibtensorflow_cc.so.2.3.0.ifso
		IMPORTED_LOCATION_RELEASE ${CMAKE_CURRENT_LIST_DIR}/../../lib/libtensorflow_cc.so.2.3.0
	...
	set_target_properties(tensorflow_cc::tensorflow_framework 
		PROPERTIES
		IMPORTED_LOCATION ${CMAKE_CURRENT_LIST_DIR}/../../lib/libtensorflow_framework.so.2.3.0
		INTERFACE_INCLUDE_DIRECTORIES "${tensorflow_cc_INCLUDE_DIRS}"
	)
	...
	set_target_properties(tensorflow_cc::tensorflow_cc
		PROPERTIES 
		IMPORTED_LOCATION ${CMAKE_CURRENT_LIST_DIR}/../../lib/libtensorflow_cc.so.2.3.0
		INTERFACE_INCLUDE_DIRECTORIES "${tensorflow_cc_INCLUDE_DIRS}"
	)
...
get_filename_component( TENSORFLOW_CC_LIBRARIES ${CMAKE_CURRENT_LIST_DIR}/../../lib/libtensorflow_cc.so.2.3.0 ABSOLUTE )
